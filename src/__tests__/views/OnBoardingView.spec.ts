...
// Mock de i18n si lo usas globalmente
...
describe("Onboarding Component", () => {
    ...
    beforeEach(() => {
        ...
        // Mock de document.getElementById para handleAnimation
    ...
    it("advances to the next step when clicking continue", async () => {
        // Buscamos el botón de continuar del paso actual
        const continueBtn = wrapper.find('.current-step .pointer-events-auto');
        await continueBtn.trigger('click');

        // El segundo paso debería estar visible ahora
    ...
    it("triggers animation on the target element when advancing", async () => {
        ...
        // El ID del segundo paso es 'stars'
