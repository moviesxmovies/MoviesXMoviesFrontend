...
const updateRoute = (page: number = 1) => {
  router.push({
    path: route.path,
    query: {
      ...route.query,
    ...
    <div class="content-layout">
      <div class="main-content">
        <div class="movies-grid">
          ...
          <div v-else-if="!users.results?.length" class="empty-state">
        ...
        <div v-if="!loading && users.total_pages > 1">
          <PaginationComponent
            data-testid="PaginationComponent"
            :data-total="users.total_pages"
            :data-current="users.current_page"
